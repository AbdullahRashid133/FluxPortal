...
#[derive(Debug)]
pub struct FluxPortalProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FluxPortalProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FluxPortal processing");
    
    let mut processor = FluxPortalProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FluxPortalProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FluxPortalProcessor::new(false);
